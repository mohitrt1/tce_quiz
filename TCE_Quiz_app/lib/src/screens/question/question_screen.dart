...
import 'package:quiz_app/src/screens/result/result_screen.dart';
import 'package:quiz_app/src/widgets/cropped_text.dart';
import 'package:quiz_app/src/util/app_routes.dart';
import 'package:quiz_app/src/widgets/timer_widget.dart';
                ...
                onTap: () {
                  ...
                  Future.delayed(Duration(milliseconds: 200), () {
                    ...
                    Future.delayed(Duration(milliseconds: 600), () async {
                      await AppRoutes.navReplace(context, ResultScreen(widget));
                    });
                  });
                },
